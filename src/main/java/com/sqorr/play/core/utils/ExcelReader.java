...
public class ExcelReader {
	 ...
	 * cj = 0;
	 * 
	 * for (int j = startCol; j < totalCols; j++, cj++) { try { tabArray[ci][cj] =
	 * getCellData(i, j); } catch (Exception e) { break; }
	 * 
	 * } }
	 * 
	 * }
	 ...
	 * return "";
	 * 
	 * } else if (dataType == 0) { Object CellData = Cell.getRawValue(); return
	 * CellData;
	 * 
	 * } else {
	 * 
	 * Object CellData = Cell.getStringCellValue(); return CellData; }
	 * 
	 * } catch (Exception e) {
	 * 
